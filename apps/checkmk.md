...
2. Signed-package installation.
	1. Depending on which optional packages were installed during the setup of your distribution, aou will need to instal `dpkg-sig` including all of its dependencies for successful verification.